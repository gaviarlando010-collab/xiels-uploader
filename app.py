    ...
    <style>
        * {
        ...
        .card {
            ...
            box-shadow: 0 25px 50px -8px rgba(0,0,0,0.8), 0 0 0 1px rgba(255,215,0,0.05);
            transition: 0.3s;
        }
        h1 {
            text-align: center;
        ...
        .sub {
            ...
            font-size: 14px;
            margin-bottom: 28px;
            border-bottom: 1px dashed #2a3350;
            padding-bottom: 16px;
        }
        .sub strong {
            color: #f1c40f;
        ...
        .btn {
            ...
            cursor: pointer;
            transition: 0.25s;
            box-shadow: 0 6px 0 #b37b0e;
        }
        .btn:hover {
            transform: translateY(-2px);
            box-shadow: 0 10px 0 #b37b0e;
        }
        .btn:active {
            transform: translateY(4px);
            box-shadow: 0 2px 0 #b37b0e;
        }
        .btn:disabled {
            opacity: 0.5;
            transform: translateY(4px);
